...
adapter methods. v1 ships exactly one adapter — [npm](./npm.md). cargo, PyPI, and others are
[deferred](../roadmap.md): the trait isolates them, but no implementations exist yet.
